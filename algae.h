...
{
public:
    Algae(std::filesystem::path in_current_path, bool mode):
        green(105, 150, 80, true), material_algae()
    {
        ...
        std::filesystem::path base = in_current_path / "models" / "in_water" / "algae";
		...
		else
		{
			...
			body_mesh1 = new Mesh3D(base / "SEPARADO", "alga1.obj");
			
			body_mesh2 = new Mesh3D(base / "SEPARADO", "alga2.obj");
			body_mesh3 = new Mesh3D(base / "SEPARADO", "alga3.obj");
		    body_mesh4 = new Mesh3D(base / "SEPARADO", "alga4.obj");
			body_mesh5 = new Mesh3D(base / "SEPARADO", "alga5.obj");
		    body_mesh6 = new Mesh3D(base / "SEPARADO", "alga6.obj");
			body_mesh7 = new Mesh3D(base / "SEPARADO", "alga7.obj");
